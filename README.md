...
This project analyzes META (Facebook) stock performance over time using R.
It explores key aspects of stock behavior — trend, volatility, and trading strategy — through data visualization and quantitative analysis.

The goal is to understand how META’s price fluctuates, how volatile it is, and how technical indicators like moving averages can help identify potential buy/sell signals.
...
🔗 [GitHub Profile](https://github.com/Helemz-data)
